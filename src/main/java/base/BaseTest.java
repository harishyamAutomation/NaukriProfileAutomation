...
public class BaseTest {
	...
	public void config(@Optional("Naukri Profile API") String reportName, @Optional("Update Report") String flow) {
		String folderPath = System.getProperty("user.dir") + "/reports/";
		BaseTestHelper.createFolder(folderPath);

		ExtentReport.getInstance().initialize(folderPath + "Naukri_Profile.html");
